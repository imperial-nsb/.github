...
This is a new technology developed in our laboratory, and we will be revealing our technology in the future.

---

**Joining our Lab**

Contact James Choi at j.choi@imperial.ac.uk if you’re interested in joining the lab.
...
* Physics
* Phantoms (eg, hydrogels, capillary microchannels)
* In vitro (eg, cell cultures, ex vivo brain slices, ex vivo human skulls)
* In vivo
...
* Ultra high-speed video camera (frame rate: 20 million frames per second)
* Emitters and receivers: single-element transducers, linear imaging array, a 256-element therapeutic ultrasound array
